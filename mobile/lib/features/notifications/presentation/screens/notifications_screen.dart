...
// ✅ FIXED: Converted to StatefulWidget to prevent infinite API calls
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  void initState() {
    super.initState();
    // ✅ Load only ONCE when the screen is first opened
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return NotificationCard(
                                  ...
                                  onPress: () => _handleNotificationPress(
                                    context,
                                    notification,
                                  ),
                                );
  ...
  void _navigateToOrder(BuildContext context, NotificationEntity notification) {
    ...
    if (orderId != null) _navigateToOrderById(context, orderId);
  }
  ...
  void _navigateToProduct(
    ...
    if (productId != null) _navigateToProductById(context, productId);
  }
