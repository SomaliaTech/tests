...
class _EditFaqScreenState extends State<EditFaqScreen> {
  ...
  void initState() {
    ...
    _orderController = TextEditingController(text: widget.faq.order.toString());
    _isActive = true; // FAQs from active list are always active
  }
  ...
  void _updateFaq() {
    ...
    context.read<AdminFaqBloc>().add(
      UpdateFaqEvent(id: widget.faq.id, faqData: faqData),
    );
  }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _isLoading ? null : _updateFaq,
