  ...
  Widget build(BuildContext context) {
    return BlocListener<AdminCategoryBloc, AdminCategoryState>(
      listener: (context, state) {
        // Close dialog when transfer succeeds
        if (state is AdminCategoriesLoading || state is AdminCategoriesLoaded) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '"${widget.categoryName}" has products. Transfer them to another category before deleting.',
                  style: TextStyle(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed:
                            _isTransferring || _selectedCategoryId == null
                            ? null
                            : _handleTransfer,
